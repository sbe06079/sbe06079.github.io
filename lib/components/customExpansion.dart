          ...
          child: MouseRegion(
            ...
            child: GestureDetector(
              ...
              child: Row(
                ...
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(0, 3, 1, 2),
                    child: Icon(
                      widget.isExpanded
                          ? Icons.arrow_drop_down
                          : Icons.arrow_right,
                      color: _isHovered
                          ? WebsiteColors.websiteBlackText // Color when hovered
                          : WebsiteColors.websiteBlackText
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: _isHovered
                            ? WebsiteColors
                                .websiteBlackText // Color when hovered
                            : WebsiteColors.websiteBlackText
                                .withOpacity(widget.isExpanded ? 0.85 : 0.30),
