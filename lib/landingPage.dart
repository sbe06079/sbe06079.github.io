...
class _LandingPageState extends State<LandingPage> {
  ...
  Widget build(BuildContext context) {
    return Title(
        ...
        color: WebsiteColors.websiteWhiteBackground,
        title: "home | evan kim",
        child: Scaffold(
                                ...
                                child: Animate(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      //color:
                                      //    Color(0xFFA5D6A7), // Background color
                                      color: WebsiteColors.memojiBackground,
                      ...
                      Animate(
                        ...
                        child: AParagraph(
                          content: MediaQuery.of(context).size.width > 1480
                              ? "I'm a recent grad from Duke University (studied Stats, CompSci, and Econ) currently working as an analyst in the Global Banking & Markets division at Goldman Sachs in New York.\n\nI was born in Korea, first came to the States when I was six, moved a lot in between. (Spent roughly half-half at this point)\n"
                              : "I'm a recent grad from Duke University (studied Stats, CompSci, and Econ) currently working as an analyst in the Global Banking & Markets division at Goldman Sachs in New York.\n\nI was born in Korea, first came to the States when I was six, moved a lot in between. (Spent roughly half-half at this point)\n",
                                    ...
                                    children: [
                                      Animate(
                                        ...
                                        child: CustomMaterialWithHover(
                                          imageUrl: 'assets/career_black.png',
                                      ...
                                      Animate(
                                        ...
                                        child: CustomMaterialWithHover(
                                          imageUrl: 'assets/coding_black.png',
                                          actionToDoOnTap: () async {
                                            context.go("/projects");
                                          },
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Animate(
                                        ...
                                        child: CustomMaterialWithHover(
                                          imageUrl: 'assets/music_black.png',
                                          actionToDoOnTap: () async {
                                            context.go("/music");
                                          },
                                          stringPhrase: 'Music',
                                      ...
                                      Animate(
                                        ...
                                        child: CustomMaterialWithHover(
                                          imageUrl: 'assets/thoughts_black.png',
                                          actionToDoOnTap: () async {
                                            context.go("/thoughts");
                                          },
