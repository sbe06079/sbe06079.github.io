                    ...
                    children: [
                      Container(
                        decoration: BoxDecoration(
                          color: makePastel(WebsiteColors.accentBlue, 0.2),
                          shape: BoxShape
                              .circle, // Ensure the container itself is circular
                        ),
                        padding: const EdgeInsets.all(
                            0), // Optional: for space between the image and the container's edge
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(
                              1000), // Large value to ensure fully rounded corners
                          child: Animate(
                            effects: const [
